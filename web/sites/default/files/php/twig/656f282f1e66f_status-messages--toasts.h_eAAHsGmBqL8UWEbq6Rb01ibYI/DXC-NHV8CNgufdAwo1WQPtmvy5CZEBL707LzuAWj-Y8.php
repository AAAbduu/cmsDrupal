...
class __TwigTemplate_1110f51ebab16c612bd6d0e7f9e81b2c extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"toast-container position-fixed top-0 end-0 p3\" aria-live=\"polite\" aria-atomic=\"true\" data-drupal-messages>
  ...
  ";
      ...
      <div ";
                // line 73
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["attributes"] ?? null), 73, $this->source), "role", "aria-label"), "addClass", [0 => ($context["classes"] ?? null)], "method", false, false, true, 73), "setAttribute", [0 => "data-drupal-selector", 1 => "messages"], "method", false, false, true, 73), "setAttribute", [0 => "role", 1 => (($__internal_compile_0 = ($context["role"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["type"]] ?? null) : null)], "method", false, false, true, 73), "setAttribute", [0 => "data-bs-autohide", 1 => (($__internal_compile_1 = ($context["autohide"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[$context["type"]] ?? null) : null)], "method", false, false, true, 73), 73, $this->source), "html", null, true);
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/misc/status-messages--toasts.html.twig", "/Applications/MAMP/htdocs/finalAssignment/web/themes/contrib/bootstrap_barrio/templates/misc/status-messages--toasts.html.twig");
    }
