    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["adopt"]) {
           ...
           ";
            ...
            <p>";
            // line 13
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_join_filter(twig_slice($this->env, twig_split_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["adopt"], "body", [], "any", false, false, true, 13), "value", [], "any", false, false, true, 13), 13, $this->source), " "), 0, 20), " "), "html", null, true);
            echo "</p>
            <p>Pet adopted: ";
            // line 14
...
";
    ...
    {
        return array (  89 => 18,  80 => 15,  76 => 14,  72 => 13,  65 => 11,  61 => 10,  57 => 8,  55 => 7,  51 => 6,  48 => 5,  44 => 4,  39 => 1,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("escape" => 6, "join" => 13, "slice" => 13, "split" => 13);
        static $functions = array("file_url" => 7, "path" => 10);

        try {
            $this->sandbox->checkSecurity(
                ['for', 'set'],
                ['escape', 'join', 'slice', 'split'],
                ['file_url', 'path']
            );
